...
import br.com.diegorsilva.human_body.domain.entities.organism.cell.geneticmaterial.IGeneticMaterial;

public class Bacterial extends Cell {
    public Bacterial(PlasmaMembrane plasmaMembrane, Cytoplasm cytoplasm, Ribosome ribosome, IGeneticMaterial geneticMaterial) {
